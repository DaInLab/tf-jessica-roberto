...
# Pacote tydyverse: é um pacote guarda-chuva que consolida uma série de ferramentas que fazem parte do ciclo da ciência de dados.
...
# readxl é parte do pacote tidyverse, um ecossistema de pacotes projetado com APIs básicos e uma filosofia compartilhada.
if (!require(readxl)) {
  install.packages("readxl")
  library(readxl)
}

# Importando a planilha no R.
# Utilizando a última versão (em 13/03/2022) dos dados contidos no Moodle.
# Foram realizadas "limpezas" nas variáveis que continham erros (data wrangling) 
